...
- **Ditto as a note-viewing client and in the app directory.** Ditto takes any NIP-19 identifier straight after its base URL, so profiles, notes and articles all open in it. Listed in the guide among the clients with a built-in account switcher. (#300)
