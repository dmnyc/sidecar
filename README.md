...
| Vendored | `nostr-tools.js`, `nip49.js` (encrypted key export), `qrcode-generator.js` (receive QR), `jsqr.js` (scan QR to pay), `emoji-data.js` (reaction picker), `fonts/` (ten faces, all SIL OFL — credited under Acknowledgments). Provenance and hashes for every bundle are in [`VENDOR.md`](VENDOR.md) |
