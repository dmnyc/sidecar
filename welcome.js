const APPS = [
  ...
  },
  {
    ...
    domain: 'stacker.news',
    cat: 'social',
    desc: 'A Hacker News-style forum where good posts and comments earn Bitcoin — share links, discuss, and get zapped.',
  },
  {
    name: 'Shopstr',
    ...
    cat: 'commerce',
    desc: 'A permissionless marketplace on Nostr — buy and sell for Bitcoin over Lightning or Cashu, directly between buyer and seller.',
  },
  {
    name: 'GratefulDay',
    ...
    cat: 'other',
    desc: 'A daily gratitude journal on Nostr — note what you’re thankful for and build a calendar of good days.',
  },
  {
    ...
    cat: 'media',
    desc: 'A podcast about Bitcoin meetup culture — real-world grassroots adoption, with Nostr sign-in and Lightning boosts to support episodes.',
  },
];
